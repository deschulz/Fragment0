...
public class Ipsum {
    ...
    static String[] Articles = {
            "Article One\n\nExcepteur pour-over occaecat squid biodiesel umami gastropub," +
                    ...
                    "trust fund excepteur eiusmod direct trade banksy nisi lo-fi cray messenger "+
                    "bag. Nesciunt esse carles selvage put a bird on it gluten-free, wes anderson "+
                    "ut trust fund twee occupy viral. Laboris small batch scenester pork belly, "+
                    ...
                    "magna shoreditch in american apparel messenger bag narwhal PBR "+
                    "ennui farm-to-table.",
            "Article Two\n\nVinyl williamsburg non velit, master cleanse four loko banh mi. "+
                    ...
                    "dolore deserunt Austin. Ad magna ethical kogi mixtape next level. "+
                    "Aliqua pork belly thundercats, ut pop-up tattooed dreamcatcher kogi "+
                    "accusamus photo booth irony portland. Semiotics brunch ut locavore irure, "+
                    "enim etsy laborum stumptown carles gentrify post-ironic cray. "+
